    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
      ...
      modelBuilder.Entity<Inventario>(entity => {
        ...
        entity.HasOne(d => d.Restaurante)
            ...
            .HasForeignKey(d => d.RestauranteId)
            .OnDelete(DeleteBehavior.ClientSetNull)
            .HasConstraintName("FK__Inventari__Resta__45F365D3");
      });
      ...
      modelBuilder.Entity<Pedido>(entity => {
        ...
        entity.HasOne(d => d.Menus)
            ...
            .OnDelete(DeleteBehavior.ClientSetNull)
            .HasConstraintName("FK__Pedido__MenuId__5441852A");

        entity.HasOne(d => d.Venta)
            .WithMany(p => p.Pedidos)
            .HasForeignKey(d => d.VentaId)
            .OnDelete(DeleteBehavior.ClientSetNull)
            .HasConstraintName("FK__Pedido__VentaId__5535A963");
      });

      modelBuilder.Entity<Persona>(entity => {
        entity.HasKey(e => e.Documento)
            .HasName("PK__Persona__AF73706C29985382");
      ...
      modelBuilder.Entity<Producto>(entity => {
        ...
        entity.Property(e => e.InventarioId).HasColumnType("numeric(5, 0)");
        ...
        entity.HasOne(d => d.Inventario)
            ...
            .OnDelete(DeleteBehavior.ClientSetNull)
            .HasConstraintName("FK__Producto__Invent__4AB81AF0");

        entity.HasOne(d => d.Menu)
            .WithMany(p => p.Productos)
            .HasForeignKey(d => d.MenuId)
            .HasConstraintName("FK__Producto__MenuId__48CFD27E");

        entity.HasOne(d => d.Proveedor)
            .WithMany(p => p.Productos)
            .HasForeignKey(d => d.ProveedorId)
            .OnDelete(DeleteBehavior.ClientSetNull)
            .HasConstraintName("FK__Producto__Provee__49C3F6B7");
      });

      modelBuilder.Entity<Proveedor>(entity => {
        entity.Property(e => e.Id).HasColumnType("numeric(3, 0)");
      ...
      modelBuilder.Entity<Venta>(entity => {
        ...
        entity.HasOne(d => d.Empleado)
            ...
            .OnDelete(DeleteBehavior.ClientSetNull)
            .HasConstraintName("FK__Venta__EmpleadoI__4F7CD00D");

        entity.HasOne(d => d.Estado)
            .WithMany(p => p.Ventas)
            .HasForeignKey(d => d.EstadoId)
            .OnDelete(DeleteBehavior.ClientSetNull)
            .HasConstraintName("FK__Venta__EstadoId__5070F446");
      });
